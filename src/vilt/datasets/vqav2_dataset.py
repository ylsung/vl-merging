...
class VQAv2Dataset(BaseDataset):
    ...
    def __getitem__(self, index):
        image_output = self.get_image(index)

        image_tensor = image_output["image"]
        ...
        if self.use_mim_transform:
            ret["image_target"] = image_output["image_target"]
            ret["image_masked_pos"] = image_output["image_masked_pos"]
